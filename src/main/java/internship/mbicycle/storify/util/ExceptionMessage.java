...
public class ExceptionMessage {
    ...
    public static final String NOT_FOUND_TOKEN = "Token not found in header";
    public static final String NOT_FOUND_STORE = "Store with id %d not found.";
    public static final String NOT_FOUND_PRODUCT = "Product with id %d not found.";
    ...
    public static final String NOT_HAVE_PERMISSION_TO_PERFORM_THIS_OPERATION = "You do not have permission to perform this operation";
}
